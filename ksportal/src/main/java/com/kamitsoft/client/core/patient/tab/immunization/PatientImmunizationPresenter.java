...
public class PatientImmunizationPresenter extends KSTabPresenter<PatientImmunizationPresenter.Display, PatientImmunizationPresenter.Proxy> {
    ...
    @ProxyCodeSplit
    @NameToken(NamesTokens.patientImmunization)
    public interface Proxy extends ProxyPlace<PatientImmunizationPresenter> {};
    
    @Inject
    public PatientImmunizationPresenter(EventBus eventBus, Display view, UserContext context, MainDictionary dictionary, Proxy proxy) {
    ...
    public TabItem getTabItem(){
        return TabItem.patientImmunization;
    }
