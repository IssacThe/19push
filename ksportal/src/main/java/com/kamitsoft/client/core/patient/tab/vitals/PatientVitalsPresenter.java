package com.kamitsoft.client.core.patient.tab.vitals;
...
public class PatientVitalsPresenter extends KSTabPresenter<PatientVitalsPresenter.Display, PatientVitalsPresenter.Proxy> {
    ...
    @ProxyCodeSplit
    @NameToken(NamesTokens.patientVitals)
    public interface Proxy extends ProxyPlace<PatientVitalsPresenter> {};
    
    @Inject
    public PatientVitalsPresenter(EventBus eventBus, Display view, UserContext context, MainDictionary dictionary, Proxy proxy) {
