...
public class PatientSocialPresenter extends KSTabPresenter<PatientSocialPresenter.Display, PatientSocialPresenter.Proxy> {
    ...
    @ProxyCodeSplit
    @NameToken(NamesTokens.patientSocial)
    public interface Proxy extends ProxyPlace<PatientSocialPresenter> {};
    
    @Inject
    public PatientSocialPresenter(EventBus eventBus, Display view, UserContext context, MainDictionary dictionary, Proxy proxy) {
