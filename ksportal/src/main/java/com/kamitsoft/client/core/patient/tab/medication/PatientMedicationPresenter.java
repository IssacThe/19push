...
public class PatientMedicationPresenter extends KSTabPresenter<PatientMedicationPresenter.Display, PatientMedicationPresenter.Proxy> {
    ...
    @ProxyCodeSplit
    @NameToken(NamesTokens.patientMedication)
    public interface Proxy extends ProxyPlace<PatientMedicationPresenter> {};
    
    @Inject
    public PatientMedicationPresenter(EventBus eventBus, Display view, UserContext context, MainDictionary dictionary, Proxy proxy) {
    ...
    public TabItem getTabItem(){
        return TabItem.patientMedication;
    }
